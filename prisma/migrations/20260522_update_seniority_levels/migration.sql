...
UPDATE job_designations jd
SET level_id = CASE 
    WHEN t.old_level_id = 1 THEN 2  -- Junior -> Junior
    WHEN t.old_level_id = 2 THEN 3  -- Mid -> Mid Level
    WHEN t.old_level_id = 3 THEN 4  -- Senior -> Senior
    ELSE t.old_level_id
END
FROM temp_old_designations t
WHERE jd.designation_id = t.designation_id;
